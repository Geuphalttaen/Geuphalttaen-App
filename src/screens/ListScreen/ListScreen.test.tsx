...
const mockRoute = { key: 'List', name: 'List' as const, params: undefined };
const mockNavigation = {
  navigate: mockNavigate,
  goBack: jest.fn(),
  replace: jest.fn(),
} as unknown as Parameters<typeof ListScreen>[0]['navigation'];
...
describe('ListScreen', () => {
  ...
  it('화장실 카드 클릭 시 Detail 화면으로 이동한다', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('Detail', { toiletId: 1 });
  });
